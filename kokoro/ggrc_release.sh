...
ISSUETRACKER_COMPONENT_ID="${ISSUETRACKER_COMPONENT_ID}"
ISSUETRACKER_HOTLIST_ID="${ISSUETRACKER_HOTLIST_ID}"
ISSUETRACKER_ISSUE_COMPONENT_ID="${ISSUETRACKER_ISSUE_COMPONENT_ID}"
ISSUETRACKER_ISSUE_HOTLIST_ID="${ISSUETRACKER_ISSUE_HOTLIST_ID}"
EOL
